...
public class Word {
    ...
    private ArrayList<String> list_mots = new ArrayList<String>(
            ...
            Arrays.asList("Albedo", "Alhaitham", "Aloy", "Amber", "Kamisato Ayaka", "Ayato", "Baizhu", "Barbara",
                    ...
                    "Voyageur Anémo", "Voyageur Géo", "Xiangling", "Xiao", "Xingqiu", "Xinyan", "Yae Miko",
    ...
    public Word() {
        ...
        mots_choisie = list_mots.get(choice);
    }
